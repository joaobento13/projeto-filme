<template>
  <div class="body-content" id="Populares">
    ...
    <div class="loading container-fluid d-flex justify-content-center align-items-center" v-if="loading">
      ...
      <div class="search container-fluid">
        <div class="row h-100">
          ...
          <div class="search-wrapper col-sm-6 p-0 d-flex align-items-center">
            <input v-model="search" class="search-input" type="text" placeholder="Procurar por um filme..."/>
          </div>
        </div>
      </div>
      ...
      <div class="conteudo container-fluid mb-4">
        <div class="row">
          ...
          <div class="col-sm-8 p-0 pt-3">
            ...
            <div class="row">
              <div class="film-content col-sm-6 pb-4" v-for="film in filteredList" v-bind:key="film.id">
                <div class="row">
                  <div class="col-sm-5">
                  ...
                  <div class="film-info col-sm-7 p-2 pr-3">
                    <div class="film-header d-flex">
                      <div class="vote_average d-flex justify-content-center align-items-center mr-2 pl-2 pr-2">
...
export default {
  data() {
    return {
      tituloSession: 'Mais bem avaliados',
      search: '',
      info: null,
      loading: true,
      errored: false,
  ...
  created() {
    axios.get('http://www.mocky.io/v2/5d4a0703320000e37d600f5d')
      .then((response) => {
  ...
  methods: {
    ...
    formatDate: (value) => {
      if (value) {
        return moment(String(value)).format('DD [de] MMMM [de] YYYY');
      }
    },
  ...
  computed: {
    filteredList() {
      return this.info.filter(film => film.original_title.toLowerCase().includes(this.search.toLowerCase()));
    },
  },
};
</script>
